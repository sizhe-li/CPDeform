...
ENVS = []
for env_name in ['Move', 'Torus', 'Rope', 'Writer', "Pinch", "Rollingpin", "Chopsticks", "Table",
                 'TripleMove', 'Assembly',
                 'ToothPaste', 'HardRope', 'FingerWriter',
                 'MultiStage_Write', 'MultiStage_Pinch', 'MultiStage_Rope',
                 'MultiStage_Move', 'MultiStage_Chair', 'MultiStage_Airplane']:
    for id in range(5):
        register(
